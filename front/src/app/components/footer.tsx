...
export const Footer = () => {
    return (
        <>
            <div className='flex justify-center text-center bg-pinks font-bold mt-12 text-xl'>
                ...
                <div>
                    <p className='my-10 max-w-4xl text-center text-blackcontent text-sm font-normal'>
                       ...
                       <span className='font-semibold'>© 2024 Sol e Art. Todos os direitos reservados.</span>  <br /> <br />

                        Estamos sempre em busca de aprimorar a nossa plataforma e oferecer a melhor experiência para você. Agradecemos por nos acompanhar nesta jornada!
