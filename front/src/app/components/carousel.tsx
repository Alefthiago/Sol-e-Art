    ...
    return (
        <>
            ...
            <div className=" hidden h-52 mt-20 max-sm:flex justify-center items-center text-center">
                <Carousel pauseOnHover rightControl=" " leftControl=" " indicators={false}>
                    <div>
                        <img src="./images/media-mob1.png" alt="..." />
                    </div>
                    <div>
                        <img src="./images/media-mob2.png" alt="..." />
                    </div>
                    <div>
                        <img src="./images/media-mob3.png" alt="..." />
                    </div>
                    <div>
                        <img  src="./images/media-mob4.png" alt="..." />
                    </div>
                    <div>
                        <img src="./images/media-mob5.png" alt="..." />
                    </div>
                </Carousel>
            </div>
